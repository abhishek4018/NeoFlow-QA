Feature: home_explore_exam_guides Flow

  Scenario Outline: Validate home_explore_exam_guides User Journey
    Given the user navigates to the home url
    When the user clicks the primary navigation link for Explore Exam Guides
    Then the main heading for "Explore Exam Guides" should be visible
