@home_create_free_assessment @quickexamcreator @vatra
Feature: home_create_free_assessment Flow

  Scenario Outline: Validate home_create_free_assessment User Journey
    Given the user navigates to the home url
    When the user clicks the primary navigation link for Create Free Assessment
    Then the main heading for Create Free Assessment should be visible
